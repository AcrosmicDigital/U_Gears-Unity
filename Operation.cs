...
namespace U.Universal
{
    ...
    public class Operation
    {
        ...
        /// <returns></returns>
        public Operation Fails(Exception error)
        {
            if (isDone)
                throw new OparationAlreadySetException();
        ...
        /// <returns></returns>
        public Operation Successful(string message = "")
        {
            if (isDone)
                throw new OparationAlreadySetException();
        ...
        public static implicit operator bool(Operation operation)
        {
        ...
        /// </summary>
        /// <param name="operation"></param>
        public static implicit operator float(Operation operation)
        {
            // Try to parse the message to a int
